...
class QGeoCodeReply(PySide2.QtCore.QObject):
    ...
    def setLocations(self, locations: typing.List[PySide2.QtPositioning.QGeoLocation]): ...
...
class QGeoRoute(Shiboken.Object):
    ...
    def setPath(self, path: typing.List[PySide2.QtPositioning.QGeoCoordinate]): ...
...
class QGeoRouteReply(PySide2.QtCore.QObject):
    ...
    def abort(self): ...
    def addRoutes(self, routes: typing.List[PySide2.QtLocation.QGeoRoute]): ...
    ...
    def setFinished(self, finished: bool): ...
    def setRoutes(self, routes: typing.List[PySide2.QtLocation.QGeoRoute]): ...
...
class QGeoRouteRequest(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, waypoints: typing.List[PySide2.QtPositioning.QGeoCoordinate] = ...): ...
    ...
    def setExcludeAreas(self, areas: typing.List[PySide2.QtPositioning.QGeoRectangle]): ...
    ...
    def setWaypoints(self, waypoints: typing.List[PySide2.QtPositioning.QGeoCoordinate]): ...
    def setWaypointsMetadata(self, waypointMetadata: typing.List[typing.Dict]): ...
...
class QPlace(Shiboken.Object):
    ...
    def setCategories(self, categories: typing.List[PySide2.QtLocation.QPlaceCategory]): ...
    def setCategory(self, category: PySide2.QtLocation.QPlaceCategory): ...
    def setContactDetails(self, contactType: str, details: typing.List[PySide2.QtLocation.QPlaceContactDetail]): ...
...
class QPlaceManager(PySide2.QtCore.QObject):
    ...
    def setLocale(self, locale: PySide2.QtCore.QLocale): ...
    def setLocales(self, locale: typing.List[PySide2.QtCore.QLocale]): ...
...
class QPlaceManagerEngine(PySide2.QtCore.QObject):
    ...
    def searchSuggestions(self, request: PySide2.QtLocation.QPlaceSearchRequest) -> PySide2.QtLocation.QPlaceSearchSuggestionReply: ...
    def setLocales(self, locales: typing.List[PySide2.QtCore.QLocale]): ...
...
class QPlaceMatchReply(PySide2.QtLocation.QPlaceReply):
    ...
    def setPlaces(self, results: typing.List[PySide2.QtLocation.QPlace]): ...
...
class QPlaceMatchRequest(Shiboken.Object):
    ...
    def places(self) -> typing.List[PySide2.QtLocation.QPlace]: ...
    def setParameters(self, parameters: typing.Dict): ...
    def setPlaces(self, places: typing.List[PySide2.QtLocation.QPlace]): ...
    def setResults(self, results: typing.List[PySide2.QtLocation.QPlaceSearchResult]): ...
...
class QPlaceSearchSuggestionReply(PySide2.QtLocation.QPlaceReply):
    ...
    def __init__(self, parent: PySide2.QtCore.QObject = ...): ...
    def setSuggestions(self, suggestions: typing.List[str]): ...
