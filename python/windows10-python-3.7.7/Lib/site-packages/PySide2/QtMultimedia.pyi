...
class QMediaContent(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, resources: typing.List[PySide2.QtMultimedia.QMediaResource]): ...
    def __copy__(self): ...
...
class QMediaNetworkAccessControl(PySide2.QtMultimedia.QMediaControl):
    ...
    def setConfigurations(self, configuration: typing.List[PySide2.QtNetwork.QNetworkConfiguration]): ...
...
class QMediaPlayer(PySide2.QtMultimedia.QMediaObject):
    ...
    def setNetworkConfigurations(self, configurations: typing.List[PySide2.QtNetwork.QNetworkConfiguration]): ...
...
class QMediaPlaylist(PySide2.QtCore.QObject, PySide2.QtMultimedia.QMediaBindableInterface):
    ...
    @typing.overload
    def addMedia(self, items: typing.List[PySide2.QtMultimedia.QMediaContent]) -> bool: ...
    def clear(self) -> bool: ...
    ...
    @typing.overload
    def insertMedia(self, index: int, items: typing.List[PySide2.QtMultimedia.QMediaContent]) -> bool: ...
