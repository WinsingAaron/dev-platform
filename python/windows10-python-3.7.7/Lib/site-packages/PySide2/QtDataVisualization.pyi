...
class QtDataVisualization(Shiboken.Object):
    ...
    class Q3DTheme(PySide2.QtCore.QObject):
        ...
        def setBaseColors(self, colors: typing.List[PySide2.QtGui.QColor]): ...
        def setBaseGradients(self, gradients: typing.List[PySide2.QtGui.QLinearGradient]): ...
    ...
    class QCustom3DVolume(PySide2.QtDataVisualization.QtDataVisualization.QCustom3DItem):
        ...
        def __init__(self, parent: PySide2.QtCore.QObject = ...): ...
        @typing.overload
        def __init__(self, position: PySide2.QtGui.QVector3D, scaling: PySide2.QtGui.QVector3D, rotation: PySide2.QtGui.QQuaternion, textureWidth: int, textureHeight: int, textureDepth: int, textureData: typing.List[typing.Char], textureFormat: PySide2.QtGui.QImage.Format, colorTable: typing.List[int], parent: PySide2.QtCore.QObject = ...): ...
