...
class QJSValue(Shiboken.Object):
    ...
    def __init__(self, value: int): ...
    def __copy__(self): ...
    def call(self, args: typing.List[PySide2.QtQml.QJSValue] = ...) -> PySide2.QtQml.QJSValue: ...
    def callAsConstructor(self, args: typing.List[PySide2.QtQml.QJSValue] = ...) -> PySide2.QtQml.QJSValue: ...
    def callWithInstance(self, instance: PySide2.QtQml.QJSValue, args: typing.List[PySide2.QtQml.QJSValue] = ...) -> PySide2.QtQml.QJSValue: ...
...
class QQmlDebuggingEnabler(Shiboken.Object):
    ...
    @staticmethod
    def setServices(services: typing.List[str]): ...
    @staticmethod
...
class QQmlEngine(PySide2.QtQml.QJSEngine):
    ...
    def importPlugin(self, filePath: str, uri: str, errors: typing.List[PySide2.QtQml.QQmlError]) -> bool: ...
    ...
    def setImportPathList(self, paths: typing.List[str]): ...
    ...
    def setPluginPathList(self, paths: typing.List[str]): ...
...
class QQmlFileSelector(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def setExtraSelectors(self, strings: typing.List[str]): ...
    @typing.overload
    def setExtraSelectors(self, strings: typing.List[str]): ...
