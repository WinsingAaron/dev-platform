...
class QAxBase(Shiboken.Object):
    ...
    @typing.overload
    def dynamicCall(self, name: str, vars: typing.List[typing.Any]) -> typing.Any: ...
    @typing.overload
    def dynamicCall(self, name: str, vars: typing.List[typing.Any], flags: int) -> typing.Any: ...
    ...
    @typing.overload
    def querySubObject(self, name: str, vars: typing.List[typing.Any]) -> PySide2.QtAxContainer.QAxObject: ...
...
class QAxScript(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def call(self, function: str, arguments: typing.List[typing.Any]) -> typing.Any: ...
    @typing.overload
    ...
    def functions(self, arg__1: PySide2.QtAxContainer.QAxScript.FunctionFlags = ...) -> typing.List[str]: ...
