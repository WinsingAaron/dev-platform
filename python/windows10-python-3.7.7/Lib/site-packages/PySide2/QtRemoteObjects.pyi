...
class QRemoteObjectAbstractPersistedStore(PySide2.QtCore.QObject):
    ...
    def saveProperties(self, repName: str, repSig: PySide2.QtCore.QByteArray, values: typing.List[typing.Any]): ...
...
class QRemoteObjectHostBase(PySide2.QtRemoteObjects.QRemoteObjectNode):
    ...
    @typing.overload
    def enableRemoting(self, model: PySide2.QtCore.QAbstractItemModel, name: str, roles: typing.List[int], selectionModel: PySide2.QtCore.QItemSelectionModel = ...) -> bool: ...
    @typing.overload
...
class QRemoteObjectReplica(PySide2.QtCore.QObject):
    ...
    def persistProperties(self, repName: str, repSig: PySide2.QtCore.QByteArray, props: typing.List[typing.Any]): ...
    ...
    def send(self, call: PySide2.QtCore.QMetaObject.Call, index: int, args: typing.List[typing.Any]): ...
    def sendWithReply(self, call: PySide2.QtCore.QMetaObject.Call, index: int, args: typing.List[typing.Any]) -> PySide2.QtRemoteObjects.QRemoteObjectPendingCall: ...
    def setChild(self, i: int, arg__2: typing.Any): ...
    def setNode(self, node: PySide2.QtRemoteObjects.QRemoteObjectNode): ...
    def setProperties(self, arg__1: typing.List[typing.Any]): ...
