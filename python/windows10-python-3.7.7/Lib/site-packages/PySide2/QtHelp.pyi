...
class QHelpEngineCore(PySide2.QtCore.QObject):
    ...
    def files(self, namespaceName: str, filterAttributes: typing.List[str], extensionFilter: str = ...) -> typing.List[PySide2.QtCore.QUrl]: ...
...
class QHelpSearchEngine(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def search(self, queryList: typing.List[PySide2.QtHelp.QHelpSearchQuery]): ...
    @typing.overload
...
class QHelpSearchQueryWidget(PySide2.QtWidgets.QWidget):
    ...
    def setQuery(self, queryList: typing.List[PySide2.QtHelp.QHelpSearchQuery]): ...
