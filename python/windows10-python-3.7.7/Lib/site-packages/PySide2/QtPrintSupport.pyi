...
class QAbstractPrintDialog(PySide2.QtWidgets.QDialog):
    ...
    def setOptionTabs(self, tabs: typing.List[PySide2.QtWidgets.QWidget]): ...
...
class QPrinter(PySide2.QtGui.QPagedPaintDevice):
    ...
    def supportedPaperSources(self) -> typing.List[PySide2.QtPrintSupport.QPrinter.PaperSource]: ...
