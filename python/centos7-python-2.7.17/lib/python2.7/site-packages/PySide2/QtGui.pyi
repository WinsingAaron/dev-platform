...
class QImage(PySide2.QtGui.QPaintDevice):
    ...
    @typing.overload
    def __init__(self, data: Char, width: int, height: int, bytesPerLine: int, format: PySide2.QtGui.QImage.Format, cleanupFunction: Callable=..., cleanupInfo: int=...): ...
    @typing.overload
    def __init__(self, data: Char, width: int, height: int, format: PySide2.QtGui.QImage.Format, cleanupFunction: Callable=..., cleanupInfo: int=...): ...
    @typing.overload
    def __init__(self, fileName: str, format: str=...): ...
    @typing.overload
...
class QPixmap(PySide2.QtGui.QPaintDevice):
    ...
    @typing.overload
    def loadFromData(self, buf: Char, len: int, format: str=..., flags: PySide2.QtCore.Qt.ImageConversionFlags=...) -> bool: ...
    @typing.overload
...
class QTouchEvent(PySide2.QtGui.QInputEvent):
    ...
    def __init__(self, eventType: PySide2.QtCore.QEvent.Type, device: PySide2.QtGui.QTouchDevice=..., modifiers: PySide2.QtCore.Qt.KeyboardModifiers=..., touchPointStates: PySide2.QtCore.Qt.TouchPointStates=..., touchPoints: List[PySide2.QtGui.QTouchEvent.TouchPoint]=...): ...
    def device(self) -> PySide2.QtGui.QTouchDevice: ...
