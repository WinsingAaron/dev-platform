...
class QWinJumpList(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def addCategory(self, title: str, items: List[PySide2.QtWinExtras.QWinJumpListItem]=...) -> PySide2.QtWinExtras.QWinJumpListCategory: ...
    def categories(self) -> List[PySide2.QtWinExtras.QWinJumpListCategory]: ...
    def clear(self): ...
...
class QWinJumpListCategory(Shiboken.Object):
    ...
    @typing.overload
    def addLink(self, icon: PySide2.QtGui.QIcon, title: str, executablePath: str, arguments: List[str]=...) -> PySide2.QtWinExtras.QWinJumpListItem: ...
    @typing.overload
    def addLink(self, title: str, executablePath: str, arguments: List[str]=...) -> PySide2.QtWinExtras.QWinJumpListItem: ...
    def addSeparator(self) -> PySide2.QtWinExtras.QWinJumpListItem: ...
    def clear(self): ...
    def count(self) -> int: ...
    def isEmpty(self) -> bool: ...
    def isVisible(self) -> bool: ...
    def items(self) -> List[PySide2.QtWinExtras.QWinJumpListItem]: ...
...
class QWinThumbnailToolBar(PySide2.QtCore.QObject):
    ...
    def buttons(self) -> List[PySide2.QtWinExtras.QWinThumbnailToolButton]: ...
    def clear(self): ...
    def count(self) -> int: ...
    ...
    def setButtons(self, buttons: List[PySide2.QtWinExtras.QWinThumbnailToolButton]): ...
