...
class QGeoPath(PySide2.QtPositioning.QGeoShape):
    ...
    def __init__(self, other: PySide2.QtPositioning.QGeoShape): ...
    @typing.overload
    def __init__(self, path: typing.List[PySide2.QtPositioning.QGeoCoordinate], width: float = ...): ...
    def __copy__(self): ...
    ...
    def setVariantPath(self, path: typing.List[typing.Any]): ...
...
class QGeoPolygon(PySide2.QtPositioning.QGeoShape):
    ...
    def __init__(self, other: PySide2.QtPositioning.QGeoShape): ...
    @typing.overload
    def __init__(self, path: typing.List[PySide2.QtPositioning.QGeoCoordinate]): ...
    def __copy__(self): ...
    def addCoordinate(self, coordinate: PySide2.QtPositioning.QGeoCoordinate): ...
    @typing.overload
    def addHole(self, holePath: typing.List[PySide2.QtPositioning.QGeoCoordinate]): ...
    @typing.overload
    ...
    def replaceCoordinate(self, index: int, coordinate: PySide2.QtPositioning.QGeoCoordinate): ...
    def setPath(self, path: typing.List[PySide2.QtPositioning.QGeoCoordinate]): ...
    def setPerimeter(self, path: typing.List[typing.Any]): ...
    def size(self) -> int: ...
    def toString(self) -> str: ...
    def translate(self, degreesLatitude: float, degreesLongitude: float): ...
...
class QGeoRectangle(PySide2.QtPositioning.QGeoShape):
    ...
    @typing.overload
    def __init__(self, coordinates: typing.List[PySide2.QtPositioning.QGeoCoordinate]): ...
    @typing.overload
